  ...
  return (
    <div className='flex items-center p-2  flex-col-reverse md:flex-row md:p-10 justify-center bg-[#d6dad9] ' >
      <div className="left-side text-center mt-5 md:text-left space-y-3 md:w-2/4 ">
        ...
        <p className='text-xl text-gray-800 font-semibold ' >Professor & Head at Dept. of Oral and Maxillofacial Surgery</p>
        <div className="buttons">
          ...
          <button
            type="button"
            class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300  font-medium rounded-lg text-base md:text-sm px-5 py-2.5 text-center mr-2 mb-2"
          >
            {" "}
            GET SPECIAL OFFERS
          </button>
      ...
      <div className="right-side shadow-2xl rounded-full  bg-[#4659ed2d] ">
           <img className='w-80 cursor-pointer  h-80 ' src={doctorImg} alt="" />
      </div>
    </div>
  );
};
